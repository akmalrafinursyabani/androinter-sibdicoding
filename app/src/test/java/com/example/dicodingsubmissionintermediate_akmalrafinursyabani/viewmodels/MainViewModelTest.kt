...
import com.example.dicodingsubmissionintermediate_akmalrafinursyabani.adapter.StoriesAdapter
import com.example.dicodingsubmissionintermediate_akmalrafinursyabani.adapter.StoriesPagingAdapter
import com.example.dicodingsubmissionintermediate_akmalrafinursyabani.data.StoryPagingSource
...
class MainViewModelTest {
    ...
    @Test
    fun `when Story fetched Should Not Null and Return Success`() = runTest {
        val dummyStory = DataStoryDummy.generateStoryDummies()
        val data: PagingData<ListStoryItem> =
            com.example.dicodingsubmissionintermediate_akmalrafinursyabani.viewmodels.StoryPagingSource.snapshot(
                dummyStory
            )
